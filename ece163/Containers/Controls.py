...
class referenceCommands():
    def __init__(self, courseCommand=VPC.InitialYawAngle, altitudeCommand=-VPC.InitialDownPosition,
...
class controlGains():
    def __init__(self, kp_roll=0.0, kd_roll=0.0, ki_roll=0.0, kp_sideslip=0.0, ki_sideslip=0.0, kp_course=0.0,
                 ki_course=0.0, kp_pitch=0.0, kd_pitch=0.0, kp_altitude=0.0, ki_altitude=0.0, kp_SpeedfromThrottle=0.0,
                 ki_SpeedfromThrottle=0.0, kp_SpeedfromElevator=0.0, ki_SpeedfromElevator=0.0):
        """
...
class controlTuning():
    def __init__(self, Wn_roll=0.0, Zeta_roll=0.0, Wn_course=0.0, Zeta_course=0.0, Wn_sideslip=0.0, Zeta_sideslip=0.0,
                 Wn_pitch=0.0, Zeta_pitch=0.0, Wn_altitude=0.0, Zeta_altitude=0.0, Wn_SpeedfromThrottle=0.0,
                 Zeta_SpeedfromThrottle=0.0, Wn_SpeedfromElevator=0.0, Zeta_SpeedfromElevator=0.0):
        """
    ...
    def __eq__(self, other):
        if isinstance(other, type(self)):
            if not all([math.isclose(getattr(self, member), getattr(other, member), abs_tol=testingAbs_tol)
                        for member in
                        ['Wn_roll', 'Zeta_roll', 'Wn_course', 'Zeta_course', 'Wn_sideslip', 'Zeta_sideslip',
